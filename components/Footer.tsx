...
import { Layers, Linkedin, Twitter, Github } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:border-cyan-400/50 transition-all">
              <Linkedin size={18} />
            </a>
            <a href="#" className="w-10 h-10 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:border-cyan-400/50 transition-all">
              <Twitter size={18} />
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-slate-400">
            <li><a href="#" className="hover:text-cyan-400 transition-colors">CSV & CSA Strategy</a></li>
            <li><a href="#" className="hover:text-cyan-400 transition-colors">MES Implementation</a></li>
            <li><a href="#" className="hover:text-cyan-400 transition-colors">Data Integrity Audit</a></li>
            <li><a href="#" className="hover:text-cyan-400 transition-colors">Smart Manufacturing</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-slate-400">
            <li><a href="#" className="hover:text-cyan-400 transition-colors">About Genval Lake</a></li>
